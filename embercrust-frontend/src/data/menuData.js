...
export const MENU_PIZZAS = [
  ...
  { id:2,  name:'Truffle Royale',      description:'Black truffle cream, burrata, wild mushroom medley, 36-month Parmigiano, truffle oil drizzle',               image:'https://images.unsplash.com/photo-1574071318508-1cdbab80d002?w=600&q=85&auto=format', category:'premium', price:34, rating:4.8, ratingCount:876,  deliveryTime:28, isVeg:true,  isPopular:true,  tag:'⭐ Premium' },
